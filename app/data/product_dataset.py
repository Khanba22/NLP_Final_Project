...
Contains technical product specifications and their summaries
"""
...
class ProductDataset:
    """
    Dataset of technical products with specifications and summaries
    for training and evaluation of product comparison summarizer
    """
    
    def __init__(self, data_path: Optional[str] = None):
        self.data_path = data_path
        self.products = self._load_sample_data() if not data_path else self._load_from_file(data_path)
        
    def _load_sample_data(self) -> List[Dict]:
        """
        Load sample technical product dataset with specifications and summaries
        """
        return [
            {
    ...
    def get_training_pairs(self) -> List[tuple]:
        ...
        Returns list of (full_description, target_summary) tuples
        """
...
def create_default_dataset() -> ProductDataset:
    """Create and return the default product dataset"""
